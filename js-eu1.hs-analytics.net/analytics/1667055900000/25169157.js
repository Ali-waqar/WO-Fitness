...
var _hsq = _hsq || [];
var _paq = _paq || [];
_hsq.push(['setPortalId', 25169157]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addCookieDomain', '.hubspotpagebuilder.eu']);
_hsq.push(['addCookieDomain', '.hs-sites-eu1.com']);
_hsq.push(['addCookieDomain', '.urbansportsclub.com']);
_hsq.push(['addCookieDomain', '.onefit.nl']);
_hsq.push(['addCookieDomain', '.hubspot.com']);
_hsq.push(['addCookieDomain', '.hsforms.com']);
_hsq.push(['enableAutomaticLinker', true]);
_hsq.push(['embedHubSpotScript', 'https://js-eu1.hs-scripts.com/25169157.js', 'hs-script-loader']);
...
(function() {
    ...
    hstc.tracking.Tracker.prototype.trackClick = function(t, e, i) {
        var n = this,
            r = {
                ...
                handler: function(t) {
                    try {
                        if (hstc.utils.isDefined(n.portalId) && hstc.utils.startsWith(e, "pe" + n.portalId + "_")) {
                            var r = t && t.target || {},
                                s = {
                                    hs_element_text: (r.innerText || "").trim(),
                                    hs_link_href: r.href,
                                    hs_element_id: r.id,
    ...
    hstc.tracking.Runner.priorityFunctions = ["setPortalId", "setCanonicalUrl", "setPath", "setContentType", "setContentMetadata", "setPageId", "setTargetedContentMetadata", "identify", "setDebugMode", "setLimitTrackingToCookieDomains", "setTrackingEnabled"];
        ...
        function _t(t, e, n, s) {
            ...
            if (!s && 1 === g.length) {
                ...
                for (; o--;) {
                    ...
                    if ((l = r.find[u]) && (s = l(h.matches[0].replace(et, it), V.test(a[0].type) && e.parentNode || e))) {
                        a.splice(o, 1);
                        if (!(t = s.length && ft(a))) {
                            O.apply(n, s);
                            return n
